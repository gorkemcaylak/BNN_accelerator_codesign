...
set C_modelArgList {
	{ test_inst_V int 64 regular  }
	{ train_inst_V int 64 regular  }
	{ min_distances_V int 6 regular {array 30 { 1 2 } 1 1 }  }
	{ min_distances_V_offset int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "test_inst_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "train_inst_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "min_distances_V", "interface" : "memory", "bitwidth" : 6, "direction" : "READWRITE"} , 
 	{ "Name" : "min_distances_V_offset", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ test_inst_V sc_in sc_lv 64 signal 0 } 
	{ train_inst_V sc_in sc_lv 64 signal 1 } 
	...
	{ min_distances_V_q1 sc_in sc_lv 6 signal 2 } 
	{ min_distances_V_offset sc_in sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "test_inst_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "test_inst_V", "role": "default" }} , 
 	{ "name": "train_inst_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "train_inst_V", "role": "default" }} , 
 	...
 	{ "name": "min_distances_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "min_distances_V", "role": "q1" }} , 
 	{ "name": "min_distances_V_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "min_distances_V_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	test_inst_V { ap_none {  { test_inst_V in_data 0 64 } } }
	train_inst_V { ap_none {  { train_inst_V in_data 0 64 } } }
	min_distances_V { ap_memory {  { min_distances_V_address0 mem_address 1 5 }  { min_distances_V_ce0 mem_ce 1 1 }  { min_distances_V_q0 mem_dout 0 6 }  { min_distances_V_address1 mem_address 1 5 }  { min_distances_V_ce1 mem_ce 1 1 }  { min_distances_V_we1 mem_we 1 1 }  { min_distances_V_d1 mem_din 1 6 }  { min_distances_V_q1 mem_dout 0 6 } } }
	min_distances_V_offset { ap_none {  { min_distances_V_offset in_data 0 64 } } }
}
