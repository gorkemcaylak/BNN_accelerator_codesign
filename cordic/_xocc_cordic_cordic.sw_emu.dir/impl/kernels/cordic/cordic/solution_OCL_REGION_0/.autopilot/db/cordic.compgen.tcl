...
set id 1
set name cordic_dadddsub_64ns_64ns_64_13_full_dsp
...
set id 7
set name cordic_dmul_64ns_64ns_64_15_max_dsp
...
set id 11
set name cordic_ddiv_64ns_64ns_64_59
...
set id 12
set name cordic_dcmp_64ns_64ns_1_2
...
set id 14
set name cordic_sitodp_32ns_64_8
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 15 \
			corename cordic_control_axilite \
			name cordic_control_s_axi \
			ports {$port_control} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cordic_control_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cordic_gmem_m_axi
}
